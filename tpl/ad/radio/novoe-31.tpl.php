...
<div class="content-block ad-new-page" role="main">
	<div class="container content-container">
		<div class=" wave__ad-inner">
			<div class="row _adnp__row wave__ad-row">
				<div class="cols _adnp__cols wave__ad-cols cols-8 _banner">
					<div class="_adnp__banner"><img src="<?=$this->path('img');?>/temp/banner-101.7.jpg" alt=""></div>
				</div>	
				<div class="cols _adnp__cols wave__ad-cols cols-4 _form">
					...
					<form action="#" class="form-site block _adnp__form wave__ad-form azbn-formsave-form"  >
						<h4 class="form__heading">Заказать рекламу<br> на Новом радио Белгород</h4>	
				...
				<div class="cols _adnp__cols wave__ad-cols cols-6 _text">
